...
/* Qwerty
 * ,-----------------------------------------------------------------------------------.
 * | Esx  |   Q  |   W  |   E  |   R  |   T  |   Y  |   U  |   I  |   O  |   P  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Tab  |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |  "   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |RS/ENT|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Ctrl  | Alt  | GUI  |Lower | DEL  |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_DEL, LOWER,   KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_mit(
    ...
    UC(0x00C4), UC(0x00D6), UC(0x00DC), _______, _______, _______, _______, _______, _______, _______, _______
),
